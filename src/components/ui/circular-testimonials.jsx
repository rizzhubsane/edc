      ...
      <div className="testimonial-grid">
        ...
        <div className="testimonial-content">
          <AnimatePresence mode="wait">
            ...
            >
              <h3 className="testimonial-name" style={{ color: colorName, fontSize: fontSizeName }}>
                {activeTestimonial.name}
              </h3>
              <p className="testimonial-designation" style={{ color: colorDesignation, fontSize: fontSizeDesignation }}>
                {activeTestimonial.designation}
              </p>
              <motion.p className="testimonial-quote" style={{ color: colorTestimony, fontSize: fontSizeQuote }}>
